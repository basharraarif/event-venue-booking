...
const AddVenuePageInternal = () => { // Renamed original component
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-8 text-gray-800">Add New Venue</h1>
...
// export default AddVenuePage; // Original export

const AddVenuePage = withAuth(AddVenuePageInternal); // Wrap component with HOC
