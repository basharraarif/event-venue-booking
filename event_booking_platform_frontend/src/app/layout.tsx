...
export const metadata: Metadata = {
  ...
  description:
    'Your go-to platform for booking venues for events in Bangladesh.',
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.className} bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex flex-col min-h-screen`}
      >
        ...
        <ErrorBoundary fallbackMessage="A critical error occurred in the application.">
          ...
          <footer className="bg-white dark:bg-gray-800 shadow-md py-6 text-center mt-auto">
            <p className="text-gray-600 dark:text-gray-300 text-sm">
              &copy; {new Date().getFullYear()} Event Booking Platform BD. All
              rights reserved.
            </p>
          </footer>
        </ErrorBoundary>
