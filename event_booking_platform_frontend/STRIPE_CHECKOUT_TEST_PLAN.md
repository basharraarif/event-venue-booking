...
*   **Idempotency:** Test creating a booking and initiating payment, then abandoning it, and trying to pay for the *same* booking again. The system should ideally use the existing PaymentIntent or handle it gracefully.
